...
namespace Lab2
{
    ...
    {       // Point of C# console application execution 
        ...
        }   // A calling method requires the declaring the method as "public" that can be used outside the class declaration. After you would use the keyword "void" so the information is not returned if you were simply using "public void DisplayMessage()" 
